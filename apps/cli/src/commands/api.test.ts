...
// process environment, never a real `~/.kvox` file) so `requireCredentials`
...
function baseCtx(
  ...
  return {
    ...
    // real home directory or a real `~/.kvox/config.json`.
 ...
 * invoke `kvox api <args...>`. Mirrors config.test.ts's
