...
// -----------------------------------------------------------------------------
// Effective schema: the resolved, frozen view one caller sees.
// -----------------------------------------------------------------------------
...
export type EffectiveEntityType = Readonly<
  Omit<EffectiveEntityTypePayload, 'attributes'> & { attributes: readonly EffectiveAttribute[] }
>;
export type EffectiveRelationType = Readonly<
  Omit<EffectiveRelationTypePayload, 'props'> & { props: readonly EffectiveAttribute[] }
>;
...
export type PropsIssue = { path: string; message: string };
