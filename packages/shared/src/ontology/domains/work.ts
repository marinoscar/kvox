...
export const project = defineEntityType({
  key: 'Project',
  domain: 'work',
  label: 'Project',
  pluralLabel: 'Projects',
  description:
    'A named effort with a start and an expected (even if fuzzy) end that meetings, decisions and commitments attach to. Positive: "Q2 pilot," "the vendor migration."',
  disambiguation: [
...
export const commitment = defineEntityType({
  key: 'Commitment',
  domain: 'work',
  label: 'Commitment',
  pluralLabel: 'Commitments',
  description:
    'A task with an owner and, optionally, a counterparty and a due date, stated or clearly implied by the source text. Positive: "Sarah will send the updated proposal by Friday" (owner: Sarah, due: Friday).',
  disambiguation: [
...
export const decision = defineEntityType({
  key: 'Decision',
  domain: 'work',
  label: 'Decision',
  pluralLabel: 'Decisions',
  description:
    'A choice that was made, with what was chosen and, when the source states it, the option that was rejected.',
  disambiguation: [
...
export const worksFor = defineRelationType({
  key: 'WORKS_FOR',
  domain: 'work',
  label: 'Works for',
...
export const hasRole = defineRelationType({
  key: 'HAS_ROLE',
  domain: 'work',
  label: 'Has role',
...
export const reportsTo = defineRelationType({
  key: 'REPORTS_TO',
  domain: 'work',
  label: 'Reports to',
...
export const attended = defineRelationType({
  key: 'ATTENDED',
  domain: 'work',
  label: 'Attended',
...
export const discussed = defineRelationType({
  key: 'DISCUSSED',
  domain: 'work',
  label: 'Discussed',
...
export const partOf = defineRelationType({
  key: 'PART_OF',
  domain: 'work',
  label: 'Part of',
...
export const assignedTo = defineRelationType({
  key: 'ASSIGNED_TO',
  domain: 'work',
  label: 'Assigned to',
...
export const owedTo = defineRelationType({
  key: 'OWED_TO',
  domain: 'work',
  label: 'Owed to',
...
export const createdIn = defineRelationType({
  key: 'CREATED_IN',
  domain: 'work',
  label: 'Created in',
...
export const decidedIn = defineRelationType({
  key: 'DECIDED_IN',
  domain: 'work',
  label: 'Decided in',
...
export const workDomain = defineDomain({
  ...
  alwaysOn: false,
  defaultEnabled: true,
  entityTypes: [project, commitment, decision],
  relationTypes: [
    worksFor,
    hasRole,
    reportsTo,
