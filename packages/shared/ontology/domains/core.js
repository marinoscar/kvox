...
exports.coreDomain = exports.supportedBy = exports.mentions = exports.supersedes = exports.identifiedAs = exports.about = exports.personFact = exports.claim = exports.meeting = exports.organization = exports.person = void 0;
...
exports.person = (0, define_js_1.defineEntityType)({
    ...
    label: 'Person',
    pluralLabel: 'People',
    description: 'A human being: one specific individual who is named, or identified unambiguously enough that exactly one real person is meant.',
    disambiguation: [
...
exports.organization = (0, define_js_1.defineEntityType)({
    ...
    description: 'A company, client, vendor, institution, or an internal team specifically when that team acts as a party to a commitment or decision rather than merely being mentioned.',
    disambiguation: [
...
exports.meeting = (0, define_js_1.defineEntityType)({
    ...
    description: 'The event anchor: a date, its attendees, and the source transcript(s) and/or note(s) it was drawn from. Created by the system for each source, never proposed by extraction.',
    disambiguation: [
...
exports.claim = (0, define_js_1.defineEntityType)({
    ...
    label: 'Claim',
    pluralLabel: 'Claims',
    description: 'A dated statement of fact about an entity that is neither a decision nor a commitment: "Acme\'s CIO is leaving in March," "the budget was cut 20%," "the pilot moved to Q2."',
    disambiguation: [
...
exports.personFact = (0, define_js_1.defineEntityType)({
    ...
    description: 'A statement about a Person as an individual rather than about their work: an interest, a preference, a personal-life detail, or a note on communication style.',
    disambiguation: [
...
exports.about = (0, define_js_1.defineRelationType)({
    key: 'ABOUT',
    domain: 'core',
    label: 'About',
...
exports.identifiedAs = (0, define_js_1.defineRelationType)({
    key: 'IDENTIFIED_AS',
    domain: 'core',
    label: 'Identified as',
...
exports.supersedes = (0, define_js_1.defineRelationType)({
    key: 'SUPERSEDES',
    domain: 'core',
    label: 'Supersedes',
...
exports.mentions = (0, define_js_1.defineRelationType)({
    key: 'MENTIONS',
    domain: 'core',
    label: 'Mentions',
...
exports.supportedBy = (0, define_js_1.defineRelationType)({
    key: 'SUPPORTED_BY',
    domain: 'core',
    label: 'Supported by',
...
exports.coreDomain = (0, define_js_1.defineDomain)({
    ...
    relationTypes: [exports.about, exports.identifiedAs, exports.supersedes, exports.mentions, exports.supportedBy],
    mixins: [],
});
